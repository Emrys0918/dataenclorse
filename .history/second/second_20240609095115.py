...
iris_data =pd.read_csv(r'D:\dataenclorse\second\iris_test.csv'
# 构造训练数据和测试数据
...
data = pd.read_csv(r'D:\dataenclorse\second\iris_test.csv', usecols=["sepal length (cm)","sepal width (cm)","petal length (cm)","petal width (cm)"])
